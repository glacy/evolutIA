...
class MaterialExtractor:
    ...
    def get_all_exercises(self, materials: List[Dict]) -> List[Dict]:
        ...
        for material in materials:
            # OPTIMIZATION: Usar diccionario para buscar soluciones en O(1) en lugar de O(N)
            ...
            for exercise in material.get('exercises', []):
                ...
                exercise_data = {
                    ...
                    'content': exercise.get('resolved_content', exercise.get('content', '')),
                    'source_file': material.get('file_path'),
                    'frontmatter': material.get('frontmatter', {}),
                    'solution': solution.get('resolved_content', solution.get('content', '')) if solution else None,
