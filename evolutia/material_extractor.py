...
class MaterialExtractor:
    ...
    def get_all_exercises(self, materials: List[Dict]) -> List[Dict]:
        ...
        for material in materials:
            # ⚡ Bolt Optimization: Replace O(N²) nested loop with O(N) hash map lookup
            # Pre-compute solution map to find matching solutions in O(1) time
            solution_map = {sol['exercise_label']: sol for sol in material['solutions']}
